package com.greenbowl.greenbowlserver.common.application.aop;

import com.greenbowl.greenbowlserver.common.utility.PerformanceMeasurer;
...
import static com.greenbowl.greenbowlserver.common.application.aop.LogMessage.PERFORMANCE_MEASUREMENT;
...
public class LoggingAspect {
    ...
    private static final String SERVICE_LOGGING_EXECUTION_POINTCUT
            = "execution(* com.greenbowl.greenbowlserver..service.*.*(..))";
    private static final String CLIENT_LOGGING_EXECUTION_POINTCUT
            = "execution(* com.greenbowl.greenbowlserver..client.*.*(..))";
